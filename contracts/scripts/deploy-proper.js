...
async function main() {
  ...
  console.log("Deploying properly linked contracts with:", deployer.address);
  ...
  // Note: Vault still needs to be updated to use PerpetualManager as authorized caller
  console.log("\n⚠️  IMPORTANT: Vault needs to be updated to authorize PerpetualManager");
  console.log("Run the link-contracts-fixed.js script next to complete the setup");
}
